###################################################################
# Innovus APR constraints (loaded by mmmc.view → design/CHIP.sdc)
# Timing from DC write_sdc (10 ns); Innovus-incompatible lines removed.
# After re-synthesis: update delays from CHIP_syn.sdc, keep edits below.
###################################################################
set sdc_version 1.8
...
# Innovus MMMC: wire_load_model not used (TCLCMD-290); RC from mmmc.view

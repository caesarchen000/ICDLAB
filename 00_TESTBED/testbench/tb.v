...
module tb;
    ...
    task send_payload_32;
        ...
        begin
            // 3) wait 72 cycles with i_valid=0
    ...
    task check_output_64;
        ...
        begin
            ...
            if (err_cnt == 0)
                ...
                $display("TB FAIL: err_cnt=%0d (outside tolerance)", err_cnt);
            $display("MSE_real=%0f, MSE_imag=%0f, MSE_total=%0f", mse_real, mse_imag, mse_total);
        end
    endtask
